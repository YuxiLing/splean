  ...
  `(tactic|
    (intros
     ...
     first
           ...
           | apply wp_of_wpgen
     all_goals try simp [wpgen, subst, isubst, subst, trm_apps, AList.lookup, List.dlookup , List.mkAlist, List.dedupKeys, List.toAList, AList.erase, List.kerase, List.eraseP, combine, trm_funs]))
